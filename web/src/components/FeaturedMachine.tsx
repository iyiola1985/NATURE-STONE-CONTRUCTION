...
export function FeaturedMachine() {
  ...
  return (
    <section id="machine" className="relative overflow-hidden bg-zinc-950 py-24 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-8 lg:px-10">
        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="space-y-6">
            <motion.div className="relative aspect-[16/11] overflow-hidden rounded-3xl border border-white/10 shadow-2xl">
              <Image
              ...
              <div className="absolute bottom-6 left-6 right-6 flex flex-wrap items-end justify-between gap-4">
                ...
                <div className="rounded-full bg-white/10 px-3 py-1 text-xs uppercase tracking-wide text-zinc-200 backdrop-blur-md">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-glass backdrop-blur-xl md:flex md:items-center md:justify-between md:gap-6">
              <div>
                ...
                <p className="text-sm text-zinc-400">Hollow blocks per day under optimized factory conditions.</p>
              </div>
              <div className="mt-6 flex flex-wrap gap-2 md:mt-0">
                {MACHINE_OUTPUTS.map((item) => (
                  <span key={item} className="rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-zinc-200">
                    {item}
                  </span>
                ))}
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-glass backdrop-blur-xl md:flex md:items-center md:justify-between md:gap-6">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-400">Receive the QT4-20 technical datasheet and cycle diagrams.</p>
              </div>
              <a
                href={`mailto:${SITE.email}?subject=${encodeURIComponent("QT4-20 brochure request")}`}
                className="mt-4 inline-flex rounded-full border border-gold/50 bg-gold/10 px-5 py-2.5 text-xs font-semibold uppercase tracking-wide text-gold transition hover:bg-gold hover:text-charcoal md:mt-0"
              >
                Download brochure
              </a>
            </div>
            ...
            <form onSubmit={submitQuote} className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-glass backdrop-blur-xl">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <button type="submit" className="rounded-full bg-gold px-6 py-3 text-xs font-semibold uppercase tracking-wide text-charcoal transition hover:bg-gold-bright">
                  Email quotation
                </button>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-full border border-white/15 px-6 py-3 text-xs font-semibold uppercase tracking-wide text-white transition hover:border-gold/50 hover:text-gold"
                >
                  WhatsApp sales
                </a>
              </div>
