...
export function VideoSection() {
  ...
  return (
    <section id="videos" className="relative overflow-hidden bg-zinc-950 py-24 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-8 lg:px-10">
        ...
        >
          <div className="relative aspect-[21/9] min-h-[280px]">
            ...
            >
              <span className="flex h-20 w-20 items-center justify-center rounded-full bg-white/15 text-white shadow-[0_20px_80px_rgba(0,0,0,0.35)] ring-1 ring-white/30 backdrop-blur-md transition group-hover:scale-105 group-hover:bg-gold group-hover:text-charcoal">
            ...
            <div className="absolute bottom-8 left-8 max-w-xl">
              ...
              <p className="mt-3 font-heading text-3xl leading-tight md:text-4xl">
        ...
        {open && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-5xl overflow-hidden rounded-3xl border border-white/15 bg-zinc-950 shadow-2xl"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="aspect-video w-full bg-black">
                {/* Set VIDEO_EMBED_URL to your YouTube embed or hosted MP4 */}
                <div className="flex h-full flex-col items-center justify-center gap-3 px-6 text-center">
                  <p className="text-sm text-zinc-300">Factory reel placeholder</p>
                  <p className="max-w-md text-xs text-zinc-500">
                    Drop in a YouTube embed URL or <code className="rounded bg-white/5 px-1">video</code> element pointing at your hosted MP4 for the QT4-20 line.
                  </p>
                </div>
              </div>
              <button
